...
const faqs = [
  ...
  {
    id: "faq-5",
    q: "Por que escolher a Salvador Câmeras?",
    a: "Com mais de 30 anos de experiência no mercado, a Salvador Câmeras se destaca pela excelência em soluções de monitoramento e segurança. Oferecemos tecnologia de ponta, suporte 24/7, manutenção incluída e atendimento personalizado para garantir a sua tranquilidade.",
  },
  {
    id: "faq-6",
    ...
    <div className="container">
      <div className="faq__header">
        ...
        <p className="section-subtitle faq__subtitle">
          Se não encontrar sua resposta, fale diretamente com nossa equipe pelo
          WhatsApp.
        </p>
      </div>
      ...
      <div className="faq__contact">
        ...
        <button
          ...
          onClick={() =>
            window.open(
              "https://wa.me/5571999999999?text=Olá! Tenho dúvidas sobre a Salvador Câmeras.",
              "_blank",
            )
          }
        >
